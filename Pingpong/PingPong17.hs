...
main = do
      ...
      setMaterial
      idleCallback $= Just (temporizador pelotaX pelotaY pelotaZ tiempo ida altura t fuerza preX posX posY puntos rx m golpe)
...
desplegar x1 y1 z1 (xp, yp) pendiente puntos= do 
               ...
               preservingMatrix $ do------Paleta y Mesa
                 ...
                 dibPaleta (xu, yu, (_DisPelota+0.1)) mi
...
temporizador pelotaX   pelotaY pelotaZ tiempo  ida   altura  ti fuerza preX xleta yleta puntos rx pendiente golpe= do
        z <- get pelotaZ
        y <- get pelotaY 
        x <- get pelotaX     
        t <- get tiempo
