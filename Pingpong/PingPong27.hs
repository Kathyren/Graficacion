...
main = do
      ...
      idleCallback $=Just (temporizador pelotaX pelotaY pelotaZ tiempo ida altura t fuerza preX posX posY puntos rx m golpe anguloPelota tiempoLapso estado p posBX posBY modo index vi)
...
temporizador pelotaX   pelotaY pelotaZ tiempo  ida   altura  ti fuerza preX xleta yleta puntos rx pendiente golpe anguloPelota tiempoLapso estado pu xb yb modo index vi= do
       z <- get pelotaZ
       y <- get pelotaY 
       x <- get pelotaX     
       t <- get tiempo
